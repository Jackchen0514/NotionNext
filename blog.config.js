...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xinsi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '程序员一枚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wiki.xinsi.us', // 网站地址
